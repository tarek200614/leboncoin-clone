...
<div style="text-align: center; padding: 3rem 0;">
    ...
    <div style="display: flex; gap: 1rem; justify-content: center;">
        <a href="/pages/annonces/liste.php" class="btn btn-primary">Parcourir les annonces</a>
        <?php if (isset($_SESSION['utilisateur_id'])): ?>
            <a href="/pages/annonces/creer.php" class="btn btn-secondary">+ Déposer une annonce</a>
        <?php else: ?>
            <a href="/pages/auth/inscription.php" class="btn btn-secondary">Créer un compte</a>
        <?php endif; ?>
    </div>
</div>
...
<div class="grid">
    ...
    <?php else: ?>
        <?php foreach ($featured_ads as $ad): ?>
            <div class="card">
                <img src="/assets/uploads/<?= e($ad['image_path'] ?? 'placeholder.jpg') ?>" alt="<?= e($ad['titre']) ?>" class="card-img" loading="lazy">
                <div class="card-body">
                    <div class="card-title"><a href="/pages/annonces/detail.php?id=<?= $ad['id'] ?>"><?= e($ad['titre']) ?></a></div>

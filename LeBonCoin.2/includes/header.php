...
<body>
    <header>
        <div class="container header-container">
            <a href="/index.php" class="logo" aria-label="Retour à l'accueil">LeBonCoin Clone</a>
            <nav aria-label="Navigation principale">
                <a href="/pages/annonces/liste.php">Annonces</a>
                <?php if (isset($_SESSION['utilisateur_id'])): ?>
                    <a href="/pages/annonces/creer.php">+ Déposer</a>
                    <a href="/pages/favoris/liste.php">Favoris</a>
                    <a href="/pages/messages/boite.php" aria-label="Messages, <?= $unread_count ?> non lus">
                    ...
                    <?php if (isset($_SESSION['utilisateur_role']) && $_SESSION['utilisateur_role'] === 'admin'): ?>
                        <a href="/pages/admin/dashboard.php" class="admin-link">Admin</a>
                    <?php endif; ?>

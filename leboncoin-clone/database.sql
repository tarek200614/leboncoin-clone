...
-- Insert realistic French users & Demo Accounts
...
('admin@demo.local', 'AdminDemo', '$2y$10$P6wCAsPaIUGOoHBeGuePLeRRnqVkSMsQaKOIsmOdipFkWH0IEWuSm', 'admin', 'active', NOW()),
('student@demo.local', 'StudentDemo', '$2y$10$P6wCAsPaIUGOoHBeGuePLeRRnqVkSMsQaKOIsmOdipFkWH0IEWuSm', 'user', 'active', NOW());
...
INSERT INTO annonces (utilisateur_id, categorie_id, titre, description, prix, location, date_creation, views) VALUES
(1, 8, 'Lot de 15 livres universitaires - Économie/Gestion',
